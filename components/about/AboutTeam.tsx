  ...
  return (
    <div className="about__team">
      <div className="about__photos-grid">
        <div className="about__wrapper-teammember">
          <div className="about__infowrapper-teammember">
            <h4 className="about__name-teammember">Christian Reber</h4>
            <div className="about__role-teammember">Founder &amp; CEO</div>
            <div className="about__socialwrapper-teammember">
              <a
                href="#"
                className="about__sociallink-teammember w-inline-block"
              >
                <div className="about__smicon-teammember w-embed">
                  <svg
                    width="26"
                    height="26"
                    viewBox="0 0 26 26"
        ...
        <div className="about__wrapper-teammember">
          <div className="about__infowrapper-teammember">
            <h4 className="about__name-teammember">Charlette Prevot</h4>
            <div className="about__role-teammember">
        ...
        <div className="about__wrapper-teammember">
          <div className="about__infowrapper-teammember">
            <h4 className="about__name-teammember">Jan Martin</h4>
            <div className="about__role-teammember">
              Co-Founder &amp; Designer
            </div>
            <div className="about__socialwrapper-teammember">
        ...
        <div className="about__wrapper-teammember">
          <div className="about__infowrapper-teammember">
            <h4 className="about__name-teammember">Eric Labod</h4>
            <div className="about__role-teammember">
        ...
        <div className="about__wrapper-teammember">
          <div className="about__infowrapper-teammember">
            <h4 className="about__name-teammember">Marvin Labod</h4>
            <div className="about__role-teammember">
        ...
        <div className="about__wrapper-teammember">
          <div className="about__infowrapper-teammember">
            <h4 className="about__name-teammember">Adam Renklint</h4>
            <div className="about__role-teammember">
              Co-Founder &amp; CTO
              <br />
            </div>
      ...
      <div className="about__2photos-wrapper">
        <div className="about__wrapper-teammember">
          <div className="about__infowrapper-teammember">
            <h4 className="about__name-teammember">Vanessa Stock</h4>
            <div className="about__role-teammember">
        ...
        <div className="about__wrapper-teammember">
          <div className="about__infowrapper-teammember">
            <h4 className="about__name-teammember">
              Misha Karpenko
              <br />
            </h4>
            <div className="about__role-teammember">
